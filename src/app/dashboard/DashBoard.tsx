  ...
  return(
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="grid grid-cols-3 grid-rows-5 gap-4 h-150">
        <div className="col-span-1 row-span-2 p-2 rounded-xl border-2 border-blue-500 bg-white">
          <Balance balance={balance} expense={totalExpenses} profit={totalProfits}/>
        </div>
        <div className="flex flex-col justify-around gap-10 col-span-2 row-span-5 p-2 rounded-xl border-2 border-blue-200 bg-white">
        ...
        <div className="col-span-1 row-span-1 p-2 rounded-xl border-2 bg-white border-blue-200">
          <Profit profit={totalProfits}/>
        </div>
        <div className="flex flex-col justify-around col-span-1 row-span-2 p-2 rounded-xl border-2 bg-white border-blue-200">
